...
final class Blockchain: Content {
    ...
    private var drivingRecordSmartContract = DrivingRecordSmartContract()
    ...
    func transactionBy(drivingLicenseNumber: String) -> [Transaction] {
        return blocks
            .flatMap {$0.transactions}
            .filter { $0.driverLicenseNumber == drivingLicenseNumber.sha1Hash()}
    }
